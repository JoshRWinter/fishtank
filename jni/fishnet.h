...
#define SERVER_STATE_GLOBAL_MINES 2
#define SERVER_STATE_GLOBAL_AIRSTRIKE_NEW 3
#define SERVER_STATE_GLOBAL_AIRSTRIKE_XPOS 4
#define SERVER_STATE_GLOBAL_AIRSTRIKE_XV 5
#define SERVER_STATE_GLOBAL_FIELDS 6
